...
- Site administrators can disable package file uploads in site policies. This requires URL-based app creation and version publishing for both the web console and API; screenshots, avatars, and existing downloads remain available.
