...
func NameI18n(v string) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldNameI18n, v))
}
...
func NameI18nEQ(v string) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldNameI18n, v))
}

// NameI18nNEQ applies the NEQ predicate on the "name_i18n" field.
func NameI18nNEQ(v string) predicate.Category {
	return predicate.Category(sql.FieldNEQ(FieldNameI18n, v))
}

// NameI18nIn applies the In predicate on the "name_i18n" field.
func NameI18nIn(vs ...string) predicate.Category {
	return predicate.Category(sql.FieldIn(FieldNameI18n, vs...))
}

// NameI18nNotIn applies the NotIn predicate on the "name_i18n" field.
func NameI18nNotIn(vs ...string) predicate.Category {
	return predicate.Category(sql.FieldNotIn(FieldNameI18n, vs...))
}

// NameI18nGT applies the GT predicate on the "name_i18n" field.
func NameI18nGT(v string) predicate.Category {
	return predicate.Category(sql.FieldGT(FieldNameI18n, v))
}

// NameI18nGTE applies the GTE predicate on the "name_i18n" field.
func NameI18nGTE(v string) predicate.Category {
	return predicate.Category(sql.FieldGTE(FieldNameI18n, v))
}

// NameI18nLT applies the LT predicate on the "name_i18n" field.
func NameI18nLT(v string) predicate.Category {
	return predicate.Category(sql.FieldLT(FieldNameI18n, v))
}

// NameI18nLTE applies the LTE predicate on the "name_i18n" field.
func NameI18nLTE(v string) predicate.Category {
	return predicate.Category(sql.FieldLTE(FieldNameI18n, v))
}

// NameI18nContains applies the Contains predicate on the "name_i18n" field.
func NameI18nContains(v string) predicate.Category {
	return predicate.Category(sql.FieldContains(FieldNameI18n, v))
}

// NameI18nHasPrefix applies the HasPrefix predicate on the "name_i18n" field.
func NameI18nHasPrefix(v string) predicate.Category {
	return predicate.Category(sql.FieldHasPrefix(FieldNameI18n, v))
}

// NameI18nHasSuffix applies the HasSuffix predicate on the "name_i18n" field.
func NameI18nHasSuffix(v string) predicate.Category {
	return predicate.Category(sql.FieldHasSuffix(FieldNameI18n, v))
}

// NameI18nEqualFold applies the EqualFold predicate on the "name_i18n" field.
func NameI18nEqualFold(v string) predicate.Category {
	return predicate.Category(sql.FieldEqualFold(FieldNameI18n, v))
}

// NameI18nContainsFold applies the ContainsFold predicate on the "name_i18n" field.
func NameI18nContainsFold(v string) predicate.Category {
	return predicate.Category(sql.FieldContainsFold(FieldNameI18n, v))
}
