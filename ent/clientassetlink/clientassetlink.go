...
const (
	// Label holds the string label denoting the clientassetlink type in the database.
	Label = "client_asset_link"
	...
	// Table holds the table name of the clientassetlink in the database.
	Table = "client_asset_links"
)

// Columns holds all SQL columns for clientassetlink fields.
var Columns = []string{
	FieldID,
	FieldAssetID,
	FieldOwnerType,
...
// OrderOption defines the ordering options for the ClientAssetLink queries.
