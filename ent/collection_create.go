...
func (_c *CollectionCreate) SetCreatorID(v int) *CollectionCreate {
...
func (_c *CollectionCreate) SetKind(v collection.Kind) *CollectionCreate {
	_c.mutation.SetKind(v)
	return _c
}

// SetNillableKind sets the "kind" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableKind(v *collection.Kind) *CollectionCreate {
	if v != nil {
		_c.SetKind(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetSortOrder(v int) *CollectionCreate {
	_c.mutation.SetSortOrder(v)
	return _c
}

// SetNillableSortOrder sets the "sort_order" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableSortOrder(v *int) *CollectionCreate {
	if v != nil {
		_c.SetSortOrder(*v)
	}
	return _c
...
func (_c *CollectionCreate) defaults() {
	...
	if _, ok := _c.mutation.Kind(); !ok {
		v := collection.DefaultKind
		_c.mutation.SetKind(v)
	}
	if _, ok := _c.mutation.SortOrder(); !ok {
		v := collection.DefaultSortOrder
		_c.mutation.SetSortOrder(v)
	}
...
func (_c *CollectionCreate) check() error {
	if _, ok := _c.mutation.CreatorID(); !ok {
		return &ValidationError{Name: "creator_id", err: errors.New(`ent: missing required field "Collection.creator_id"`)}
	}
	...
	if _, ok := _c.mutation.Kind(); !ok {
		return &ValidationError{Name: "kind", err: errors.New(`ent: missing required field "Collection.kind"`)}
	}
	...
	if _, ok := _c.mutation.SortOrder(); !ok {
		return &ValidationError{Name: "sort_order", err: errors.New(`ent: missing required field "Collection.sort_order"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
