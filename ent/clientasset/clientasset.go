...
const (
	// Label holds the string label denoting the clientasset type in the database.
	Label = "client_asset"
	...
	// Table holds the table name of the clientasset in the database.
	Table = "client_assets"
)

// Columns holds all SQL columns for clientasset fields.
var Columns = []string{
	FieldID,
	FieldSha256,
	FieldMediaType,
...
// OrderOption defines the ordering options for the ClientAsset queries.
