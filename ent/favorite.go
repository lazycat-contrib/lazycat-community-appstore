...
type Favorite struct {
	...
	TargetType favorite.TargetType `json:"target_type,omitempty"`
...
func (*Favorite) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case favorite.FieldID, favorite.FieldUserID, favorite.FieldTargetID:
	...
	for i := range columns {
		...
		case favorite.FieldTargetType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.TargetType = favorite.TargetType(value.String)
			}
