...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/client/v1/sources/{id}/wishes", s.clientAPI(s.handleListSourceWishes))
	s.mux.HandleFunc("POST /api/client/v1/sources/{id}/wishes", s.clientAPI(s.handleCreateSourceWish))
	s.mux.HandleFunc("GET /api/client/v1/sources/{id}/wishes/{wishId}", s.clientAPI(s.handleGetSourceWish))
	s.mux.HandleFunc("PATCH /api/client/v1/sources/{id}/wishes/{wishId}", s.clientAPI(s.handleUpdateSourceWish))
	s.mux.HandleFunc("DELETE /api/client/v1/sources/{id}/wishes/{wishId}", s.clientAPI(s.handleDeleteSourceWish))
