...
func sourceDTO(source *ent.ClientSource) SourceDTO {
	...
	dto := SourceDTO{
		...
		ClientPolicy: normalizeSourceClientPolicy(SourceClientPolicyDTO{
			MinVersion:      source.MinClientVersion,
			Message:         source.MinClientVersionMessage,
			ForceAdsDisplay: source.ForceAdsDisplay,
		}),
